...
class MavenMirror extends BaseSkill {
  constructor() {
    super('maven-mirror', {
      description: '配置 Maven 国内镜像',
      version: '1.0.0'
    });
  }

  execute(params = {}) {
    const mirrorUrl = params.mirrorUrl || 'https://maven.aliyun.com/repository/public';
    const result = {
      name: 'Maven Mirror',
      success: false,
      configPath: '',
...
module.exports = new MavenMirror();
