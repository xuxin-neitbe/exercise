...
from agents.simple_agent import SimpleAgent, HelloAgentsLLM
...
def main():
    ...
    print("=" * 80, flush=True)
    print("NoteTool 与 ContextBuilder 集成示例", flush=True)
    print("=" * 80 + "\n", flush=True)
